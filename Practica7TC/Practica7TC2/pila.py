...
# Verifica si es terminal o no terminal.
def done():
	if found:
		print "Yeah! La palabra \"" + start_input + "\" es parte de la gramatica."
	else:
		print "Ups! La palabra \"" + start_input + "\" no es parte de la gramatica."



# UI
# Lee automata desde archivo .txt
filename = raw_input("Inserte nombre de archivo con automata de pila dentro:\n")
while not parse_file(filename):
	print "Archivo no encontrado! :("
	filename = raw_input("Inserta nombre de archivo con automata otra vez:\n")
print "Se creo correctamente el automata :D"

start_input = raw_input("Inserte palabra:\n")
...
while start_input != "fin":
	...
	start_input = raw_input("Ingrese otra palabra o fin:\n")
	print "Verificando palabra \"" + start_input + "\" ..."
